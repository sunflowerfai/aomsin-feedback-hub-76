...
import { Menu, X, LogOut, RotateCcw, LayoutDashboard, MapPin, MessageSquareText, AlertTriangle, Bot, FileText } from "lucide-react";
...
import { CustomerFeedbackPage } from "@/components/dashboard/CustomerFeedback/CustomerFeedbackPage";
const Dashboard = () => {
  ...
  const [selectedYear, setSelectedYear] = useState(currentYear >= 2567 && currentYear <= 2568 ? currentYear.toString() : "2568");
      ...
      case "สรุปภาพรวมประจำเดือน":
        return <div className="space-y-8">
            ...
            <div className="space-y-8">
              ...
              {/* Regional Comparison Card - Full width row */}
      ...
      <main className="main-content transition-all duration-200 ease-out min-h-screen">
        <div className="container mx-auto p-6">
          <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            {activeMenu === "สรุปภาพรวมประจำเดือน" && <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <Select value={selectedMonth} onValueChange={setSelectedMonth}>
                    ...
                    <SelectContent className="bg-white border border-border rounded-xl shadow-lg max-h-[300px]">
                      {thaiMonths.map(month => <SelectItem key={month.value} value={month.value} className="font-kanit hover:bg-muted/50 focus:bg-muted/50">
                          {month.label}
                        </SelectItem>)}
                    </SelectContent>
                  </Select>
